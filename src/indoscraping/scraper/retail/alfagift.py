...
def scrape_alfagift(date_str, output_path, limit_categories=None, limit_articles=None, force=False, output_format="json"):
    ...
    cache_dir = f"data/retail/alfagift/.cache/{date_str}"
...
def main():
    ...
    parser.add_argument("--output", default="data/retail/alfagift/latest.json", help="Output path for the latest scraping results")
    ...
    if all_products:
        ...
        history_path = f"data/retail/alfagift/history/{date_str}.{history_ext}"
