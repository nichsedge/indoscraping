...
def main():
    parser = argparse.ArgumentParser(description="Scrape priority products from Blibli categories.")
    ...
    output_file = f'data/blibli/blibli_priority_data.{output_format}'
